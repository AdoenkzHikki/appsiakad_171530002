...
public class IfrProdi extends javax.swing.JInternalFrame {
    ...
    private void showDataProdi(){
        try{
            ...
            sqlselect = "select * from tbprodi a, tbjurusan b"
                    + " where a.kd_jur=b.kd_jur order by b.jurusan desc";
    ...
    private void aksiSimpan(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Errot method aksiSimpan() :"+ex);
        }
    }
    ...
    private void aksiHapus(){
        ...
        if(jawab == JOptionPane.YES_OPTION){
            try{
                _Cnn = null;
                _Cnn = getCnn.getConnection();
                sqldelete = "delete from tbprodi where kd_jur='"+vkd_prodi+"' ";
                Statement stat = _Cnn.createStatement();
    ...
    private void initComponents() {
        ...
        cmbJurusan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Pilih --", "Teknik Informatika", "Teknik Mesin", "Teknik Kimia" }));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtKdProdi, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtProdi, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))
